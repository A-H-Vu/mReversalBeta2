...
expName = 'mReversalBeta2'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Andrew\\Documents\\Work\\Projects\\m-reversal-beta2\\mReversalBeta2_lastrun.py',
...
for thisTrials1 in trials1:
    ...
    trial1Num.text = str(trials1.thisN+1)+' / 20'
    
    trial1Cursor.pos = (1.5,1.5)
    trial1Mouse.pos = (1.5,1.5)
    # keep track of which components have finished
    trial1Components = [trial1Mouse, trial1Target, trial1Home, trial1Cursor, trial1Num]
...
for thisTrials2 in trials2:
    ...
    #print('trial: '+str(trials1.thisN)+' ('+str(globalClock.getTime())+')')
    trial2Num.text = str(trials2.thisN+1)+' / 90'
...
for thisTrials3 in trials3:
    ...
    trials3.addData('trial1Mouse.x', trial1Mouse.x)
    trials3.addData('trial1Mouse.y', trial1Mouse.y)
    trials3.addData('trial1Mouse.leftButton', trial1Mouse.leftButton)
    trials3.addData('trial1Mouse.midButton', trial1Mouse.midButton)
    trials3.addData('trial1Mouse.rightButton', trial1Mouse.rightButton)
    trials3.addData('trial1Mouse.time', trial1Mouse.time)
    trials3.addData('trial1Mouse.started', trial1Mouse.tStartRefresh)
    trials3.addData('trial1Mouse.stopped', trial1Mouse.tStopRefresh)
    # thisExp.addData('step', stepvector)
    thisExp.addData('step', steps)
    thisExp.addData('targetangle_deg', targetangle)
    ...
    #psychoJS.experiment.addData('step', steps)
    #psychoJS.experiment.addData('targetangle_deg', targetangle)
    trials3.addData('trial1Target.started', trial1Target.tStartRefresh)
    trials3.addData('trial1Target.stopped', trial1Target.tStopRefresh)
    trials3.addData('trial1Home.started', trial1Home.tStartRefresh)
    trials3.addData('trial1Home.stopped', trial1Home.tStopRefresh)
    trials3.addData('trial1Cursor.started', trial1Cursor.tStartRefresh)
    trials3.addData('trial1Cursor.stopped', trial1Cursor.tStopRefresh)
    trials3.addData('trial1Num.started', trial1Num.tStartRefresh)
    trials3.addData('trial1Num.stopped', trial1Num.tStopRefresh)
    # the Routine "trial1" was not non-slip safe, so reset the non-slip timer
    routineTimer.reset()
    thisExp.nextEntry()
