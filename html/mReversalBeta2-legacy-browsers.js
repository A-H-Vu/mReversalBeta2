...
let expName = 'mReversalBeta2';  // from the Builder filename that created this script
...
function trial1RoutineBegin(trials) {
  return function () {
    ...
    trial1Step = 1;
    steps = [];
    trial1Num.text = ((trials1.thisN + 1).toString() + " / 20");
...
function trial2RoutineBegin(trials) {
  return function () {
    ...
    trial2Step = 1;
    steps = [];
    trial2Num.text = ((trials2.thisN + 1).toString() + " / 90");
